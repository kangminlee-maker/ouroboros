"""Evaluation workflow handlers.

- EvaluateHandler: Three-stage evaluation pipeline
- MeasureDriftHandler: Goal deviation measurement
"""
...
class EvaluateHandler:
    ...
    async def _has_code_changes(self, working_dir) -> bool | None:
