...
_CODEX_LLM_BACKENDS = frozenset({"codex", "codex_cli"})
...
def get_agent_permission_mode() -> str:
    ...
    Priority:
        ...
        2. config.yaml orchestrator.permission_mode
        3. "acceptEdits"
    """
